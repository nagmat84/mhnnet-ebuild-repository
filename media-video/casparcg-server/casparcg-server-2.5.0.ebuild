...
# dev-libs/simde               from src/CMakeModules/Bootstrap_Linux.cmake: ADD_COMPILE_DEFINITIONS (USE_SIMDE)
...
PATCHES=(
	"${FILESDIR}/${P}-add-missing-boost-includes.patch"
