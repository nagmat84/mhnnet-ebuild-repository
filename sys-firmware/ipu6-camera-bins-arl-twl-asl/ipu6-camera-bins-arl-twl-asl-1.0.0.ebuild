...
SRC_URI="https://github.com/intel/ipu6-camera-bins/archive/refs/tags/v${PV}-iot-arl-twl-asl-v6.12.tar.gz -> ${P}.tar.gz"
LICENSE="unknown"
SLOT="0"
KEYWORDS="~amd64"
...
S="${WORKDIR}/ipu6-camera-bins-${PV}-iot-arl-twl-asl-v6.12"
