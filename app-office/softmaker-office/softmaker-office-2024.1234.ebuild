...
# .deb dependencies as of 2024-06-06, version 2024-1214:
#
# On Gentoo:
#
#  - Emerge app-arch/dpkg
#  - Download *.deb-archive (e.g. https://www.softmaker.net/down/softmaker-office-${PV//\./_}_amd64.deb)
#  - Run dpkg-deb -I softmaker*.deb to get dependencies information
#
#   DEBIAN                                        GENTOO
#
...
src_prepare() {
	...
	expected_hash="4166bef1d45190b130ebfd11c5eda5d1"
	...
	# extract
	tail -n 1613 ${WORKDIR}/installsmoffice | head -n 1375 > ${WORKDIR}/smoffice-install-functions.sh
...
src_install() {
	...
	# TODO: what about the provided fonts, there's no global registration in the original install script?
}
